...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    ...
    $stmt->bind_param("issss", $_SESSION['user_id'], $_POST['item_name'], $_POST['description'], $_POST['date_found'], $_POST['location']);
    if ($stmt->execute()) {
        $msg = "success";
    } else {
        $msg = "error";
...
<body>
    <div class="wrapper">
        ...
        <div class="card">
            <div class="header">
                <h1><i class="fas fa-search-plus" style="color:var(--primary)"></i> Report Found Item</h1>
            </div>

            <?php if ($msg === "success"): ?>
                <div class="alert alert-success">
                    <i class="fas fa-check-circle"></i> Found Item reported successfully!
                </div>
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" placeholder="Describe the found item" required></textarea>
                </div>
                <div class="form-group">
